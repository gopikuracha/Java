...
public class LDAPConnect {
	...
	private static final String LDAP_SERVER = "ldap://<host:port>";
	private static final String LDAP_SEARCH_BASE = "dc=<domain>,dc=<domain>";
    ...
    public static void main(String[] args) throws NamingException {
        ...
        final String ldapAdServer = LDAP_SERVER;
        final String ldapSearchBase = LDAP_SEARCH_BASE;
        
        final String ldapUsername = LDAP_USERNAME;
        final String ldapPassword = LDAP_PASSWORD;
        
        final String ldapAccountToLookup = "IDF1DEV";
